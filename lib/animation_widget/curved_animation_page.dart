...
class _CurvedAnimationPageState extends State<CurvedAnimationPage>
  ...
  var iconList = [
    ASConstant.others + 'other_2.jpeg',
    ASConstant.others + 'other_3.jpeg',
    ASConstant.others + 'other_4.jpeg',
    ASConstant.others + 'other_5.jpeg',
  ];
  var _index = 0;
  var _index1 = 1;
  Widget child1;
  ...
  Widget buildSubPage(String iconPath) {
    return Container(
      ...
      width: ScreenUtil().screenWidth - ASScreenAdapter.width(3),
